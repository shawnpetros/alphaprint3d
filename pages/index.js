...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>AlphaPrint3D</title>
        <meta
          name="description"
          content="AlphaPrint3D is a veteran co-owned business specializing in industrial applications of 3D printing and modeling services. Additional services include prototyping and consulting"
        />
          ...
          <div className="content">
            ...
            <form {...{ onSubmit, id: "subscribe" }}>
              ...
              >
                <input
                  type="text"
                  name="b_8ff9ff93a268e168508a539a1_0933557fe1"
                  tabIndex="-1"
                />
              </div>
              <button form="subscribe" className="button" type="submit">
                Submit
              </button>
            </form>
